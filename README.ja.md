...
> **注：** 以下のプレースホルダー画像は、実際のデプロイ画面のスクリーンショットに置き換えてください。例については [docs/screenshots/](docs/screenshots/) を参照してください。
...
**ダッシュボード概要**
- 色分けされたステータス付きのリアルタイムディスク使用量カード
- 過去の傾向を示すインタラクティブなチャート
- サイトのフィルタリングと検索機能
- 月次増加統計
